...
public class SystemLogAspect {
    ...
    public Object doAround(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        log.info("**********   Url: {}, Start: {}, End: {}, Total: {}ms, Code: {}   **********", url, DateTimeUtils.dateFormat( new Date( startTime ), "yyyy-MM-dd HH:mm:ss:SSS" ), DateTimeUtils.dateFormat( new Date( endTime ), "yyyy-MM-dd HH:mm:ss:SSS" ), totalTime, result==null?null:result.getCode() );
